...
class TestParametersTypes(unittest.TestCase):
    ...
    def setUp(self):
        ...
        self.tran time step = self.ParametersObj.tran time step
    ...
    def test_types(self):
        ...
        self.assertIsInstance(self.tran time step, float)
