...
class TestQuadcellTypes(unittest.TestCase):
    ...
    def setUp(self):
        ...
        self.QuadcellObj = Quadcell(nn, theta, jx, jy, na, ma, xx, outx_l, outx, outy, cell_qc, stepp, slope, slope_ex, x_edge, qc_type, has_microlens, A_intensity, B_intensity, C_intensity, D_intensity)
